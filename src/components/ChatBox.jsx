...
const ChatBox = ({ selectedUser, setSelectedUser }) => {
  ...
  return (
    <>
      {selectedUser ? (
        <section className="flex flex-col h-screen w-full bg-slate-900">
          {/* Header */}
          <header className="flex items-center gap-3 border-b border-slate-700/50 p-4 bg-slate-800/70 backdrop-blur-md sticky top-0 z-10">
            <button
              className="flex lg:hidden items-center justify-center p-1 rounded-full
            ...
            <div>
              <h3 className="font-semibold text-slate-200 text-lg">
                {selectedUser?.fullName || "Echoe User"}
              </h3>
              <p className="font-light text-slate-400 text-sm">
                @{selectedUser?.username || "Echoe"}
              </p>
            </div>
          </header>
        ...
        <section className="hidden lg:flex h-screen w-full bg-slate-900 flex-col justify-center items-center">
